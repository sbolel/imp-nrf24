...
/*----------------------------------------------------------------------------*/
  ...
  function read_register(regAddr) {                   /* Read a reagister */
    csn(0);                                           // Chip select
  ...
  function write_register(regAddr, data) {            /* Write data to a reg */
...
/* REFERENCE: Configuration arrays for pipe constants (From Arduino RF24 lib)
...
/*----------------------------------------------------------------------------*/
  ...
  function startListening() {
    ...
    /* TODO (Incomplete funtion, not sure if needed)
